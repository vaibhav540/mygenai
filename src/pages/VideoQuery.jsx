...
import { Home as HomeIcon, VideoLibrary as VideoIcon } from "@mui/icons-material";
import "../styles/videoquery.css";
...
const VideoQuery = () => {
  ...
  return (
    <Box className="video-query-container">
      <Navbar />
